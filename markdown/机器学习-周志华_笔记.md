...
![equation](http://latex.codecogs.com/gif.latex?f({\itx}=w_1x_1+w_2x_2+...+w_dx_d+b)),![equation](http://latex.codecogs.com/gif.latex?f({\itx}=w^Tx+b))，![equation](http://latex.codecogs.com/gif.latex?{\itw}=(w_1,w_2,...,w_d))，   
