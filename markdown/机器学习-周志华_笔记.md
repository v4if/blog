...
先将数据集![equation](http://latex.codecogs.com/gif.latex?D)划分为k个大小相似的互斥子集，![equation](http://latex.codecogs.com/gif.latex?D=D_1\bigcup D_2\bigcup ... \bigcup D_k,D_i \bigcap D_j=\cancel{O})
